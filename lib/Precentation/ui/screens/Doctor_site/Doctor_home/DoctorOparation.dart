...
class DoctorOperation extends StatefulWidget {
  const DoctorOperation({super.key});

  @override
  State<DoctorOperation> createState() => _DoctorOperationState();
}

class _DoctorOperationState extends State<DoctorOperation> {
